...
var routes = require(serverDir+'routes/index');
var users = require(serverDir+'routes/users');
...
app.use('/public',express.static(path.join(__dirname,clientDir)));//定义一个虚拟目录便于打包
